...
export async function GET(request: Request) {
  try {
    ...
    return NextResponse.json({
      ...
      requested_by_user_id: snapshot.run.requested_by_user_id || null,
      requested_by_allowed_user_id: snapshot.run.requested_by_allowed_user_id || null,
      requested_by_email: snapshot.run.requested_by_email || null,
      requested_by_name: snapshot.run.requested_by_name || null,
      requested_by_role: snapshot.run.requested_by_role || null,
      status,
      phase,
